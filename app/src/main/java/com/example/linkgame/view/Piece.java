...
public class Piece {
     ...
     * 保存方块对象的所对应的图片
     */
    private com.example.linkgame.view.PieceImage pieceImage;
    /**
     * 该方块的左上角的x坐标
     */
    private int beginX;
     ...
     */
    public com.example.linkgame.view.PieceImage getPieceImage() {
        return pieceImage;
    }
     ...
     * @param pieceImage
     */
    public void setPieceImage(com.example.linkgame.view.PieceImage pieceImage) {
