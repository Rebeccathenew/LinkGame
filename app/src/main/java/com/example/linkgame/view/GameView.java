...
public class GameView extends View {
     ...
     * 保存当前已经被选中的方块
     */
    private com.example.linkgame.view.Piece selectedPiece;
    /**
     * 连接信息对象
     */
     ...
     * @param piece
     */
    public void setSelectedPiece(com.example.linkgame.view.Piece piece) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        com.example.linkgame.view.Piece[][] pieces = gameService.getPieces();
        if (pieces != null) {
            // 遍历pieces二维数组
            for (int i = 0; i < pieces.length; i++) {
                for (int j = 0; j < pieces[i].length; j++) {
                    ...
                    if (pieces[i][j] != null) {
                        // 得到这个Piece对象
                        com.example.linkgame.view.Piece piece = pieces[i][j];
