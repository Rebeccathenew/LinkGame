...
import com.example.linkgame.board.impl.GameServiceImpl;
 ...
 * 游戏Activity <br/>
 */
public class LinkActivity extends Activity implements com.example.linkgame.BaseHandlerCallBack {
    ...
    private static class NoLeakHandler<T extends com.example.linkgame.BaseHandlerCallBack> extends Handler {
